...
from utils import scheme, filename, intpadding, kv_pairs
...
class Website:
    ...
    def get_db_data(self):
        ...
        track_names_json = json.dumps([self.parent.audio.get('track', filename(i)) for i in self.parent.audio.lists['paths']])
