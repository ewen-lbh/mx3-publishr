...
if 'Environment':
	...
	TESTING_MODE = False  # recreates "initial file conditions" by deleting files generated by script (to restart fresh)
...
if 'Files':
	...
	# relative to orginal cover size. Eg. 0.5 is half the size of the original.
	COVER_LOWRES_SIZE = 0.5
...
if 'Fields':
	...
	# The separator for descriptions.txt : What's before is english, what's after is french.
	DESCRIPTION_LANG_SEPARATOR = '////'
...
if 'YouTube':
    ...
    """
	# other possible keys : microseconds, seconds, hours, minutes
	YOUTUBE_DELAY = {
		'days' : 1,
		'hours': 0,
		'weeks': 0,
...
if 'Database':
	...
	DATABASE_BROWSER_HEADLESS = True

if 'Website Filesystem':
	...
	WEBSITE_PATHS = {
		...
		'covers_dirs'     : ['fullres_square/[kind]/', 'fullres_landscape/[kind]/', 'square/[kind]/',
							 'landscape/[kind]/'],
...
if 'Features':
	...
	# Maximum retries count for ask functions
	ASK_MAX_RETRIES = 10

	# does not display "confirm" messages, and uses AUTO_MODE_CHOICES as choices
	AUTO_MODE = True
	AUTO_MODE_CHOICES = {
		'apply_metadata'           : False,
		'cover_arts_crop_direction': 'right',
		'website'                  : False,
		'database'                 : False,
		'youtube'                  : False,
		'create_videos'            : False,
	...
	# ask for auto mode and what tasks to do
	AUTO_MODE_ASK_TASKS = True
	AUTO_MODE_ASK = True
...
if 'Watermark':
	...
	SHOW_LOGTYPES_IN_WATERMARK = True

	import watermark
	WATERMARK = watermark.text

	SCRIPT_END_MESSAGE = """Thank you for using this script !
    
    
    If you have any issue, or a feature idea, please open an issue here:
    {cc}github.com/ewen-lbh/mx3-publishr{c}
    
    I take graphism requests
    {cc}mx3creations.com/contact{c}
    
    You can also learn more about what I make
    {cc}mx3creations.com/about-me{c}
    
    """.format(
		cc=CLI_STYLING_CODES['YELLOW'],
